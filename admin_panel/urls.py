...
urlpatterns = [
    ...
    path('users/<int:user_id>/permission/<str:key>/', views.toggle_user_permission, name='toggle_user_permission'),
    path('videos/', views.videos_list, name='videos'),
    path('videos/create/', views.video_create, name='video_create'),
    path('videos/bulk/', views.video_bulk_action, name='video_bulk_action'),
    ...
    path('deposits/<int:payment_id>/approve/', views.approve_payment, name='approve_payment'),
    path('deposits/<int:payment_id>/reject/', views.reject_payment, name='reject_payment'),
